...
async def get_text_prompt_queue_item(message: discord.Message, json_card: dict[str, Any],context,dimension) -> None:
...
async def get_spatial_prompt_queue_item(message: discord.Message, character_response , json_card: dict[str, Any],context) -> None:
    user:str = message.author.display_name
    user = user.replace(" ", "")
